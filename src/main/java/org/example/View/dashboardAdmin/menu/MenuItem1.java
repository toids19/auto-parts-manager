...
public class MenuItem1 extends JPanel {
    ...
    private final org.example.View.dashboardAdmin.menu.Menu menu;
    ...
    private org.example.View.dashboardAdmin.menu.PopupSubmenu popup;

    public MenuItem1(Menu menu, String menus[], int menuIndex, List<MenuEvent> events) {
        this.menu = menu;
        this.menus = menus;
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("org/example/View/dashboardAdmin/menu/icon" + menuIndex + ".svg");
    ...
    private void init() {
        ...
        for (int i = 0; i < menus.length; i++) {
            ...
            if (i == 0) {
                ...
                menuItem.addActionListener((ActionEvent e) -> {
                    if (menus.length > 1) {
                        if (menu.isMenuFull()) {
                            MenuAnimation.animate(MenuItem1.this, !menuShow);
                        } else {
                            popup.show(MenuItem1.this, (int) MenuItem1.this.getWidth() + UIScale.scale(5), UIScale.scale(menuItemHeight) / 2);
                        }
                    } else {
        ...
        popup = new org.example.View.dashboardAdmin.menu.PopupSubmenu(getComponentOrientation(), menu, menuIndex, menus);
    }
