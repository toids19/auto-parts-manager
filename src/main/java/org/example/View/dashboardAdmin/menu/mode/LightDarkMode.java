package org.example.View.dashboardAdmin.menu.mode;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("org/example/View/dashboardUser/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("org/example/View/dashboardUser/menu/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("org/example/View/dashboardUser/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("org/example/View/dashboardUser/menu/mode/light.svg"));
        }
    }
