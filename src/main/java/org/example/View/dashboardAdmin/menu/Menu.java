...
import org.example.View.dashboardAdmin.menu.mode.*;
import org.example.View.dashboardAdmin.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
            {"~Aplicații~"},
            {"Portal Utilizatori","Creare Utilizator/Administrator","Vizualizare Utilizatori Sistem", "Vizualizare Admini Sistem"},
            {"Portal Produse","Creare Produs","Vizualizare Listă Produse"},
            {"Portal Comenzi","Vizualizare Listă Comenzi"},
            {"Deconectare"}
    };
    ...
    public void setMenuFull(boolean menuFull) {
        ...
        for (Component com : panelMenu.getComponents()) {
            if (com instanceof org.example.View.dashboardAdmin.menu.MenuItem1) {
                ((org.example.View.dashboardAdmin.menu.MenuItem1) com).setFull(menuFull);
            }
        }
    ...
    private final String headerName = "NOVOCAR S.R.L";
    ...
    private void init() {
        ...
        //header.setIcon(new ImageIcon(getClass().getResource("view/dashboard/icon/png/logo.png")));
        header.putClientProperty(FlatClientProperties.STYLE, ""
                + "font:$Menu.header.font.deriveFont(24f);"  // Adjust the font size here
    ...
    private void createMenu() {
        ...
        for (int i = 0; i < menuItems.length; i++) {
            ...
            if (menuName.startsWith("~") && menuName.endsWith("~")) {
                ...
                MenuItem1 menuItem1 = new MenuItem1(this, menuItems[i], index++, events);
                panelMenu.add(menuItem1);
            }
        }
    }
