package org.example.View.dashboardUser.menu;

import org.example.View.dashboardUser.menu.mode.LightDarkMode;
import org.example.View.dashboardUser.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
            {"~Aplicații~"},
            {"Portal Comenzi","Creare Comandă","Comenzile Mele"},
            {"Deconectare"}
    };
