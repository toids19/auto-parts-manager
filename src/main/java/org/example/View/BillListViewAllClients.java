...
public class BillListViewAllClients extends JPanel {

    private DefaultTableModel tableModel;
    private final BillRepository billRepository;

    public BillListViewAllClients() {
    ...
    private void refreshBillsTable() {
        ...
        List<Bill> bills = billRepository.getAllBills(); // Fetch bills for all clients
    ...
    public  void generatePDFInvoice(Bill bill) {
        try {
            ...
            String saveDirectory = "/Users/moldovanutudor/Desktop/PT/PT2024_30421_Moldovanu_Tudor/pt2024_30421_moldovanu_tudor_assignment_3/GeneratedBills_ADMIN";
